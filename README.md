...
<table width="100%" border="0" style="background-color: #0d1117; border-radius: 10px;">
  <tr>
    <td style="padding: 20px;">
      <p align="left">
        I am a <b> Software Engineer </b> dedicated to architecting high-availability systems. My methodology merges rigorous computer science fundamentals with modern agile full-stack practices.
      </p>
